...
export const PREFAB_DEFINITIONS: PrefabDefinition[] = [
  ...
  def("traffic_light", "prop", mp.trafficLight, 4, 6, ["urban", "street"]),
  def("trash_can", "prop", mp.trashCan, 4, 3, ["urban", "street"]),
  def("bus_stop", "prop", mp.busStop, 3, 10, ["urban", "street"]),
  def("fire_hydrant", "prop", mp.fireHydrant, 4, 4, ["urban", "street"]),
  def("dumpster", "prop", mp.dumpster, 4, 5, ["urban", "industrial", "street"]),
  def("road_barrier", "prop", mp.roadBarrier, 6, 7, ["urban", "military", "street"]),
  def("traffic_cone", "prop", mp.trafficCone, 4, 3, ["urban", "street"]),
  def("billboard", "prop", mp.billboard, 4, 9, ["urban", "street"]),
  def("planter", "prop", mp.planter, 6, 6, ["urban", "street"]),
  def("mailbox", "prop", mp.mailbox, 4, 4, ["suburban", "street"]),
