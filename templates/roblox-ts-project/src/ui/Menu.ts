...
export class Menu {
	...
	private build(): void {
		...
		text(GameConfig.name, new UDim2(1, -24, 0, 46), new UDim2(0, 12, 0, 12), hero, { size: 34, align: Enum.TextXAlignment.Center, color: textOnGradient(theme.primary), zIndex: 6, scaled: true });
